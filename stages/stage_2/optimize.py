from alvm import KEYWORD_TO_ATOM

from alvm_tools.pattern_match import match
from alvm_tools.binutils import assemble

from alvm_tools.NodePath import NodePath, LEFT, RIGHT
...
def optimize_sexp(r, eval):
    """
    Optimize an s-expression R written for alvm to R_opt where
