...
def patch_build_ext(build_ext):
    # allow to use 'alvm_extensions' parameter for setup() call
    ...
    def has_ext_modules(self):
        return (
            ...
            or self.alvm_extensions
            and len(self.alvm_extensions) > 0
        )
    ...
    def finalize_options(self):
        ...
        if self.distribution.alvm_extensions:
            mods.extend(self.distribution.alvm_extensions)
